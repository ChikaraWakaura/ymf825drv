...
extern void Fmvoice_damp( Fmvoice* _this );
extern void Fmvoice_chgVibDpt( Fmvoice* _this, unsigned char vibDpt );
extern void Fmvoice_chgChVol( Fmvoice* _this, unsigned char chVol );
extern void Fmvoice_chgExpression( Fmvoice* _this, unsigned char Expression );
