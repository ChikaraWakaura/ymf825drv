...
ブレッドボードで基礎的動作確認が終わりましたので他実験で使用していた[秋月ユニバーサル基板](http://akizukidenshi.com/catalog/g/gP-11073/)を  
一度フリーにしてから配置、配線しました。
...
YMF825-MIDI.xml は [Domino](http://takabosoft.com/domino) 向けファイルです。利用される場合は Domino\Module へ  
